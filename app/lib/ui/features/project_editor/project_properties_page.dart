...
class ProjectPropertiesPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final coordinator = SideTabFeatureCoordinator.of<void>(context);
    ...
    final page = SideTabFeaturePage(
      ...
      initialTabIndex: coordinator?.tabIndex ?? 0,
      onTabSelected: coordinator == null ? null : (index) => coordinator.tabIndex = index,
      tabBodies: [
